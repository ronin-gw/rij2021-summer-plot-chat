...
GAMES = (
    ("始まりのあいさつ", 1628617363.939, 0, 12, 51),
    ("ポケットモンスター ソード&シールド", 1628617363.939, 0, 47, 13),
    ("ポケパークWii ～ピカチュウの大冒険～", 1628617363.939, 5, 37, 24),
    ("Inmost", 1628617363.939, 8, 4, 48),
    ("CUPHEAD", 1628617363.939, 9, 11, 45),
    ("ケモノヒーローズ", 1628617363.939, 10, 7, 21),
    ("LOVE 2: kuso", 1628617363.939, 10, 51, 59),
    ("Super Cable Boy", 1628617363.939, 11, 11, 32),
    ("Donut County", 1628617363.939, 12, 3, 10),
    ("10秒走 RETURNS", 1628617363.939, 12, 55, 42, "right"),
    ("ドラゴンクエストVIII 空と海と大地と呪われし姫君", 1628617363.939, 13, 24, 56),
    ("ソフィーのアトリエ\n～不思議な本の錬金術士～ DX", 1628617363.939, 20, 58, 32),
    ("Assault Spy", 1628617363.939, 24, 2, 10),
    ("ゼルダ無双 厄災の黙示録", 1628617363.939, 25, 1, 10),
    ("デスクリムゾン", 1628617363.939, 29, 12, 57),
    ("エアホッケー＠GAMEPACK", 1628617363.939, 30, 13, 33, "right"),
    ("ペプシマン", 1628617363.939, 30, 27, 53),
    ("ビューティフルジョー", 1628617363.939, 31, 10, 49),
    ("Phoenotopia: Awakening", 1628617363.939, 32, 0, 30),
    ("メタルスラッグ5", 1628617363.939, 34, 18, 1, "right"),
    ("テイルズオブデスティニー ディレクターズカット", 1628617363.939, 35, 5, 26),
    ("クラッシュ・バンディクー4 とんでもマルチバース", 1628761128.537, 0, 3, 50),
    ("ゼルダの伝説 神々のトライフォース", 1628761128.537, 2, 11, 47),
    ("星のカービィ スターアライズ", 1628761128.537, 3, 30, 4),
    ("星のカービィ ロボボプラネット", 1628761128.537, 5, 15, 44),
    ("メジャー Wii パーフェクトクローザー", 1628761128.537, 7, 18, 50, "right"),
    ("マリオテニスアドバンス", 1628761128.537, 7, 38, 52),
    ("野生動物運動会", 1628761128.537, 9, 27, 39),
    ("カニノケンカ -Fight Crab-", 1628761128.537, 10, 34, 11),
    ("Age of Empires III:\nDefinitive Edition", 1628761128.537, 11, 35, 42),
    ("デススマイルズメガブラックレーベル", 1628761128.537, 12, 27, 25),
    ("聖剣伝説3 TRIALS of MANA", 1628761128.537, 13, 37, 48),
    ("バレットウィッチ", 1628761128.537, 16, 52, 8),
    ("ASTRO's PLAYROOM", 1628761128.537, 17, 21, 52),
    ("SEKIRO: SHADOWS DIE TWICE", 1628761128.537, 17, 56, 59),
    ("Indivisible", 1628761128.537, 18, 44, 35),
    ("零～zero～", 1628761128.537, 21, 12, 16),
    ("Bloodstained: Curse of the Moon 2", 1628761128.537, 22, 46, 10),
    ("ロックマン4", 1628761128.537, 23, 42, 59),
    ("白き鋼鉄のX THE OUT OF GUNVOLT", 1628761128.537, 24, 52, 5, "right"),
    ("デモンズブレイゾン 魔界村 紋章編", 1628761128.537, 25, 31, 58),
    ("Golf It!", 1628761128.537, 26, 27, 52),
    ("Wild Guns", 1628761128.537, 27, 9, 13),
    ("ミスタードリラーアンコール", 1628761128.537, 27, 37, 12),
    ("はたらくUFO", 1628761128.537, 28, 17, 40),
    ("Dr.エッグマンの\nミーンビーン\nマシーン", 1628761128.537, 28, 54, 23),
    ("遊戯王ファイブディーズ ウィーリーブレイカーズ", 1628761128.537, 29, 16, 7),
    ("マリオカート64", 1628761128.537, 30, 10, 35),
    ("ときめきメモリアル", 1628761128.537, 30, 52, 42),
    ("首都高バトル01", 1628761128.537, 31, 54, 13),
    ("ギャラクティックストーム", 1628761128.537, 33, 45, 28),
    ("東方紺珠伝 ～ Legacy of Lunatic Kingdom.", 1628761128.537, 34, 22, 27),
    ("東方紅輝心", 1628761128.537, 35, 15, 56),
    ("Hollow Knight", 1628761128.537, 35, 45, 40),
    ("サイバーシャドウ", 1628761128.537, 36, 39, 33),
    ("スーパーマリオギャラクシー2", 1628761128.537, 37, 47, 4, "right"),
    ("ソニックアドベンチャー2", 1628761128.537, 41, 2, 0),
    ("バイオハザード\n（1996）", 1628761128.537, 41, 51, 43),
    ("バイオハザード4", 1628761128.537, 42, 55, 26),
    ("Hades", 1628761128.537, 44, 41, 47),
    ("ファイアーエムブレム\n蒼炎の軌跡", 1628925763.117, 0, 11, 16),
    ("Deathstate", 1628925763.117, 2, 24, 36),
    ("魔法使いハナビィ", 1628925763.117, 2, 40, 47),
    ("サルゲッチュ3", 1628925763.117, 3, 13, 20),
    ("バーニングレンジャー", 1628925763.117, 4, 30, 18),
    ("快速天使", 1628925763.117, 5, 10, 36),
    ("高橋名人の冒険島3", 1628925763.117, 5, 55, 55),
    ("ザ・グレイトバトルII ラストファイターツイン", 1628925763.117, 6, 23, 49),
    ("謎の村雨城", 1628925763.117, 7, 4, 21),
    ("俺の料理", 1628925763.117, 7, 25, 23),
    ("ワギャンパラダイス", 1628925763.117, 8, 5, 36),
    ("ドンキーコング(GB)", 1628925763.117, 8, 58, 37),
    ("XIゴ", 1628925763.117, 10, 51, 53),
    ("バトルガレッガ", 1628925763.117, 12, 3, 32),
    ("DanceDance\nRevolution\nSuperNOVA", 1628925763.117, 13, 24, 5),
    ("新・北海道4000km", 1628925763.117, 14, 0, 51),
    ("桃太郎電鉄～昭和 平成 令和も定番！～", 1628925763.117, 14, 51, 23),
    ("リングフィットアドベンチャー", 1628925763.117, 17, 22, 54, "right"),
    ("終わりのあいさつ", 1628925763.117, 17, 56, 50, "right")
)
